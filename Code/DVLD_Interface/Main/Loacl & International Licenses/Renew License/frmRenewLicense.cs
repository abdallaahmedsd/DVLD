...
namespace DVLD_Interface.Main.Renew_License
{
    public partial class frmRenewLicense : Form
    {
        clsManageAppTypes _Service = clsManageAppTypes.Find((int)clsApplication.enApplicationType.RenewDrivingLicense);
        ...
        private void _FillLicenseObject()
        {
            ...
            byte validYears = _LicenseClass.DefaultValidityLength;
            _NewLicense.ExpiryDate = DateTime.Now.AddYears(validYears);
            ...
            _NewLicense.LicenseClassID = _LicenseClass.LicenseClassID;
        ...
        private void btnRenewLicense_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Cannot renew this license because it is deactivated", "Deactivated License", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            {
                MessageBox.Show("Cannot create a renew license application", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            if (MessageBox.Show("Are you sure you wanna renew this license?", "Confirm Renew License", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                if (_NewLicense.Save())
                {
                    MessageBox.Show($"License has been renewed successfully with ID ({_NewLicense.LicenseID})", "Succeeded", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void ctrLocalLicenseCardWithSearchBar1_OnLicenseSelected(int obj)
        {
            ...
            btnRenewLicense.Enabled = (licenseID != -1);
            ...
            if (licenseID != -1)
            {
                ...
                {
                    MessageBox.Show($"Selected license is not yet expired. It'll expiry on {_OldLicense.ExpiryDate.ToShortDateString()}", "Not Expired", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    btnRenewLicense.Enabled = false;
                }
            }
